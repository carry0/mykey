...
public class DiscoverListviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(mcontext).inflate(R.layout.listviewadapter_discover,null);
            viewHoled = new ViewHoled();
            viewHoled.message_img = convertView.findViewById(R.id.discover_img);
